  ...
  return (
    <>
      <motion.section
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed left-0 top-0 z-[100] h-full w-full bg-[#0D111D]/[95%]"
      ></motion.section>
      <section className="custom__container fixed left-0 top-0 z-[200] flex h-full items-center justify-center">
        ...
        >
          <div className="h-fit w-full flex-col items-center justify-start overflow-hidden rounded-[19.5px] bg-[#F8F6F5] lg:w-[27.086vw] lg:max-w-none lg:rounded-[1.333vw] dark:bg-[#1B202A]">
                    ...
                    <div className="flex w-full flex-col items-center justify-center gap-y-1 lg:gap-y-[0.361vw]">
                      ...
                      <div className="w-full">
                        {isExtractSuccess ? (
                          <button
                            onClick={reset}
                            className="w-full text-center text-sm font-medium text-red-500 lg:text-[0.903vw] lg:leading-[1.3vw] dark:text-red-500"
                          >
                            Reset
                          </button>
                        ) : (
                          <>
                            <label
                              htmlFor="pdf"
                              className="my-3 block w-full rounded-lg border border-dashed border-white/60 py-8 text-center text-base text-white lg:my-[0.8vw] lg:py-[2vw] lg:text-[1.084vw]"
                            >
                              {selectedFile === null
            ...
            {/* B. Button & Footer */}
            <div className="relative flex h-[148px] w-full items-center justify-center lg:h-[8.125vw]">
              <div className="flex w-full flex-col items-center gap-y-5 px-6 lg:gap-y-[1.445vw] lg:px-[1.463vw]">
                {/* Buttons 💳 */}
                {isExtractSuccess ? (
                  <button
